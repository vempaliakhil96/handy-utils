...
def html_to_asf(el: Union[BeautifulSoup, NavigableString, Tag, str], ctx: Optional[Dict] = None) -> str:
    ...
    inner = (
        "".join(html_to_asf(cast(Union[BeautifulSoup, NavigableString, Tag, str], c), ctx) for c in el.children)
